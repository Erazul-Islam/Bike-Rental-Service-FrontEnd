    ...
    return (
        <div className=''>
            ...
            <div className='mt-28 md:ml-60 md:flex justify-between gap-12'>
                ...
                <div>
                    <div className='rounded-none ml-36 lg:ml-0  text-center h-10 mt-12 w-40 pt-2  bg-red-700 ' >MISSION STATEMENT</div>
                    <div className='md:text-4xl text-center md:text-left  font-bold mt-10'>HELPS YOU TO FIND YOUR NEXT <br /> MOTORBIKE EASILY</div>
                    <div className='mt-12 mr-4 text-center md:text-left'>The glamour of ten decades can be this timeless and modern. This motorcycle was, <br />
            ...
            <div className='md:ml-60 md:mr-60'>
                <div className='rounded-none ml-36 text-center lg:ml-0  h-10 mt-12 w-40 pt-2 bg-red-700 ' >OUR TEAM</div>
                <div className='text-3xl mb-20  text-center  md:text-left font-bold mt-10'>MEET OUR TEAM</div>
                <div className='md:flex gap-8'>
                    <div>
                        ...
                        <div className='text-center mb-4  mt-4'>Director of Marketing</div>
                    </div>
                    <div>
                        <img src="https://i.ibb.co/V3ZWMTx/27.jpg" alt="" />
                        <div className='text-center mt-4  text-xl'>Rasha Islam</div>
                        <div className='text-center mt-4 mb-4'>Media Buyer</div>
                    </div>
                    <div>
                        ...
                        <div className='text-center mb-4 mt-4'>Marketing Manager</div>
                    </div>
                    <div>
            ...
            <div className='rounded-none md:ml-60 md:mr-60 ml-36 lg:ml-0 text-center h-10 mt-12 w-40 pt-2 bg-red-700 '>BIG ACHIEVEMENT</div>
            <img className='mt-12' src="https://i.ibb.co/WfhDfn0/bike-news-image-161751501484263.jpg" alt="" />
            <div className='md:ml-60 md:mr-60'>
                <div className='rounded-none text-center ml-36 lg:ml-0 h-10 mt-12 w-40 pt-2 bg-red-700 '>CONTACT INFO</div>
                ...
                <div className=' ml-8 md:ml-40 md:mr-40'>

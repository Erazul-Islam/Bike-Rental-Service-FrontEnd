...
const About = () => {
    return (
        <div className='dark'>
            ...
            <div className='mt-28 md:ml-60 flex gap-12'>
                <img className='w-1/4' src="https://i.ibb.co/6HLR1ts/harley-davidson-6-OBa-II5-Go-unsplash.jpg" alt="" />
                <div>
                    <Button color='warning' className='rounded-none mt-4 h-20 text-xl' >Mission Statement</Button>
                    <h1 className='text-5xl font-bold mt-10'>HELPS YOU TO FIND YOUR NEXT <br /> MOTORBIKE EASILY</h1>
                    <p className='mt-12 text-xl'>The glamour of ten decades can be this timeless and modern. This motorcycle was, <br />
            ...
            <div className='md:ml-60 md:mr-60'>
                <Button color='warning' className='rounded-none mt-20 h-20 text-xl' >OUR TEAM</Button>
                <h1 className='text-5xl mb-20 font-bold mt-10'>MEET OUR TEAM</h1>
                <div className='flex gap-8'>
                    <div>
                        <img src="https://i.ibb.co/wdhVmFY/thisisengineering-raeng-DKPh3-G8-HLRU-unsplash.jpg" alt="" />
                        <h1 className='text-center mt-4 text-xl'>Taosif Mahbub</h1>
                        <h1 className='text-center mt-4'>Director of Marketing</h1>
                    </div>
                    <div>
                        <img src="https://i.ibb.co/V3ZWMTx/27.jpg" alt="" />
                        <h1 className='text-center mt-4 text-xl'>RASHA ISLAM</h1>
                        <h1 className='text-center mt-4'>Media Buyer</h1>
                    </div>
                    <div>
                        <img src="https://i.ibb.co/4sWhV2j/thisisengineering-raeng-b-MTdk-0-SIw-unsplash.jpg" alt="" />
                        <h1 className='text-center mt-4 text-xl'>Sohagi Samiya</h1>
                        <h1 className='text-center mt-4'>Marketing Manager</h1>
                    </div>
                    <div>
                        <img src="https://i.ibb.co/nmBfhHg/thisisengineering-raeng-ov-WUKV1bt-Xk-unsplash.jpg" alt="" />
                        <h1 className='text-center mt-4 text-xl'>Sayma ISLAM</h1>
                        <h1 className='text-center mt-4'>Operations Manager</h1>
                    </div>
                </div>
            </div>
            ...
            <div>
                ...
                <div className='flex justify-between md:ml-40 md:mr-40'>
                    <div className='text-xl flex gap-4'>
                        ...
                        <h1>Need I help? Talk to an Expert <br />
                            (+88) 1900 888 666</h1>
                    </div>
                    <div className='text-xl flex gap-4'>

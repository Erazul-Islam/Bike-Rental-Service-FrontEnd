        ...
        <div>
            ...
            <div className='lg:ml-60 lg:mr-60 lg:flex gap-8'>
                ...
                <div>
                    ...
                    <h3 className='text-xl md:text-3xl  ml-8 md:ml-0  mt-3'>America – Winter Riding Routes That Are Awesome!
                    </h3>
                    <p className='text-xl ml-8 md:ml-0 mt-3'>Where the Expedition truly distinguishes itself from the Norden 901 is in componentry. It shares the more stout Xplor suspension</p>
                </div>
            </div>
        </div>
    );
